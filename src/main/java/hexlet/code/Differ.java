...
public class Differ {
    public static String generate(Map<String, Object> firstMap, Map<String, Object> secondMap) throws Exception {
        StringBuilder sb = new StringBuilder();
        Map<String, Object> temp = new TreeMap<>(Comparator.comparing(s -> s.substring(1)));
        sb.append("{");
        temp.put("\n", "");
